  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-slate-50">
          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center gap-4 md:gap-6">
              ...
              <div className="md:hidden flex items-center">
                <button
                  onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}                  className="text-slate-500 p-2"
                >
                  {isMobileMenuOpen ? (
                    <X className="h-6 w-6" />
                  ) : (
          ...
          <>
            ...
            <div className="md:hidden bg-white border-t border-slate-100 px-4 pt-2 pb-6 shadow-xl absolute w-full left-0 z-50">
              <div className="flex flex-col space-y-2">
                ...
                {/* NOVÉ TLAČÍTKO PRO SROVNÁVAČ V MOBILNÍM MENU */}
                <button
                  onClick={() => navigateTo("compare")}
                  className="px-4 py-3 text-left font-medium text-slate-700 bg-slate-50 rounded-lg"
                >
      ...
      <main>
        ...
        {/* ZDE SE ZOBRAZÍ NOVÝ SROVNÁVAČ */}
        {currentPage === "compare" && <ComparisonPage navigateTo={navigateTo} />}
